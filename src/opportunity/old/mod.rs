...
use anyhow::Result;
use crate::exchanges::types::{ArbitrageOpportunity, SwapQuote};
use std::sync::Arc;
use std::any::Any;
...
pub struct ArbitrageEngine {
    ...
    min_profit_bps: i32,
    max_risk_score: crate::exchanges::types::RiskScore,
}
...
impl ArbitrageEngine {
    pub fn new(scanner: Arc<dyn OpportunityScanner>, min_profit_bps: i32) -> Self {
        Self {
            scanner,
            min_profit_bps,
            max_risk_score: crate::exchanges::types::RiskScore::Medium,
        }
    }
    ...
    pub fn set_max_risk_score(&mut self, risk_score: crate::exchanges::types::RiskScore) {
